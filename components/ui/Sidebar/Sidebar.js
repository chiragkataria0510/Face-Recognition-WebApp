...
const structure = [
  ...
  { id: 7, label: "Help", link: "mailto:chiragkataria1214@gmail.com", icon: <HelpOutlineIcon /> },
  { id: 10, type: "divider" },
  { id: 11, type: "title", label: "CONTACT" },
  {
    id: 13,
    label: "Github",
    link: "https://github.com/chiragkataria0510/Face-Recognition-WebApp",
    icon: <GitHubIcon/>
  },
  {
    id: 14,
    label: "Linkedin",
    link: "https://www.linkedin.com/in/chirag-kataria-59b37b261/",
    icon: <LinkedInIcon/>,
  },
];
